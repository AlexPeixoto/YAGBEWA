...
void OpCodeMapping::Call::ADD(char**, Memory::Map&, OpStructure&){}
...
void OpCodeMapping::Call::RLCA(char**, Memory::Map&, OpStructure& info){
    //Store the 7th bit on carry
    //cpu.registers.c = cpu.registers.a >> 7 & 0x1;
    LR35902::registers.A = LR35902::registers.A << 1;
    LR35902::registers.F.Z = (LR35902::registers.A == 0);

}
void OpCodeMapping::Call::RRCA(char** pc, Memory::Map& memMap, OpStructure& info){
    //cpu.registers.c = cpu.registers.a  & 0x1;
    LR35902::registers.A = LR35902::registers.A >> 1;
    LR35902::registers.F.Z = (LR35902::registers.A == 0);
}
...
void OpCodeMapping::Call::LD_REG_d8(char** pc, Memory::Map& memMap, OpStructure& info){}
...
void OpCodeMapping::Call::RRA(char** pc, Memory::Map& memMap, OpStructure& info){
    //Rotate through C, meaning that C moves to the leftmost but, then receive the shifted value
}
